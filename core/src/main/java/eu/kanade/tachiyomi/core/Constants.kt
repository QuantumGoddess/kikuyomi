...
object Constants {
    ...
    const val AUDIOBOOK_EXTRA = "audiobook"
    ...
    const val SHORTCUT_AUDIOBOOKLIB = "eu.kanade.tachiyomi.SHOW_AUDIOBOOKLIB"
    const val SHORTCUT_LIBRARY = "eu.kanade.tachiyomi.SHOW_LIBRARY"
    const val SHORTCUT_ANIME = "eu.kanade.tachiyomi.SHOW_ANIME"
    const val SHORTCUT_AUDIOBOOK = "eu.kanade.tachiyomi.SHOW_AUDIOBOOK"
    ...
    const val SHORTCUT_AUDIOBOOKEXTENSIONS = "eu.kanade.tachiyomi.AUDIOBOOKEXTENSIONS"
    const val SHORTCUT_EXTENSIONS = "eu.kanade.tachiyomi.EXTENSIONS"
    const val SHORTCUT_ANIME_DOWNLOADS = "eu.kanade.tachiyomi.SHOW_ANIME_DOWNLOADS"
    const val SHORTCUT_AUDIOBOOK_DOWNLOADS = "eu.kanade.tachiyomi.SHOW_AUDIOBOOK_DOWNLOADS"
