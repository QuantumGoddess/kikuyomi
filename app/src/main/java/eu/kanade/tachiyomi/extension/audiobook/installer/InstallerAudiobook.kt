package eu.kanade.tachiyomi.extension.audiobook.installer
 ...
 */
abstract class InstallerAudiobook(private val service: Service) {

    private val extensionManager: AudiobookExtensionManager by injectLazy()
    ...
    companion object {
        private const val ACTION_CANCEL_QUEUE = "InstallerAudiobook.action.CANCEL_QUEUE"
        private const val EXTRA_DOWNLOAD_ID = "InstallerAudiobook.extra.DOWNLOAD_ID"
