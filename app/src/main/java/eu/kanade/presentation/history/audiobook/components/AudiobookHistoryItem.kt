...
@Composable
fun AudiobookHistoryItem(
    history: AudiobookHistoryWithRelations,
    onClickCover: () -> Unit,
    onClickResume: () -> Unit,
    onClickDelete: () -> Unit,
...
private fun HistoryItemPreviews(
    @PreviewParameter(AudiobookHistoryWithRelationsProvider::class)
    historyWithRelations: AudiobookHistoryWithRelations,
) {
    TachiyomiTheme {
        Surface {
