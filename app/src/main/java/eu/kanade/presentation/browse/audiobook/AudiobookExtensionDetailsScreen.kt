...
import eu.kanade.tachiyomi.ui.browse.audiobook.extension.details.AudiobookExtensionDetailsScreenModel
...
@Composable
fun AudiobookExtensionDetailsScreen(
    navigateUp: () -> Unit,
    state: AudiobookExtensionDetailsScreenModel.State,
...
@Composable
private fun AudiobookExtensionDetails(
    contentPadding: PaddingValues,
    extension: AudiobookExtension.Installed,
    sources: List<AudiobookExtensionSourceItem>,
    onClickSourcePreferences: (sourceId: Long) -> Unit,
    onClickUninstall: () -> Unit,
    onClickSource: (sourceId: Long) -> Unit,
) {
    ...
    Column {
        Column(
            ...
            val strippedPkgName = extension.pkgName.substringAfter(
                "eu.kanade.tachiyomi.audiobookextension.",
            )
...
private fun SourceSwitchPreference(
    source: AudiobookExtensionSourceItem,
    onClickSourcePreferences: (sourceId: Long) -> Unit,
    onClickSource: (sourceId: Long) -> Unit,
    modifier: Modifier = Modifier,
) {
    ...
    TextPreferenceWidget(
        ...
        widget = {
            Row(
                ...
                if (source.source is ConfigurableAudiobookSource) {
