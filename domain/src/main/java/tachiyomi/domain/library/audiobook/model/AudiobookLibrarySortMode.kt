package tachiyomi.domain.library.audiobook.model

import tachiyomi.domain.category.model.Category
import tachiyomi.domain.library.model.FlagWithMask
import tachiyomi.domain.library.model.plus

data class AudiobookLibrarySort(
    val type: Type,
    ...
    object Serializer {
        fun deserialize(serialized: String): AudiobookLibrarySort {
            return Companion.deserialize(serialized)
        }

        fun serialize(value: AudiobookLibrarySort): String {
    ...
    companion object {
        ...
        val default = AudiobookLibrarySort(Type.Alphabetical, Direction.Ascending)

        fun valueOf(flag: Long?): AudiobookLibrarySort {
            if (flag == null) return default
            return AudiobookLibrarySort(
                Type.valueOf(flag),
        ...
        fun deserialize(serialized: String): AudiobookLibrarySort {
            ...
            return try {
                ...
                val type = when (values[0]) {
                    ...
                    "LAST_AUDIOBOOK_UPDATE" -> Type.LastUpdate
                ...
                AudiobookLibrarySort(type, ascending)
            } catch (e: Exception) {
                default
            }
        }
    ...
    fun serialize(): String {
        val type = when (type) {
            ...
            Type.LastUpdate -> "LAST_AUDIOBOOK_UPDATE"
...
val Category?.sort: AudiobookLibrarySort
    get() = AudiobookLibrarySort.valueOf(this?.flags)
