...
data class Audiobook(
    ...
    val updateStrategy: AudiobookUpdateStrategy,
    ...
    val skipIntroLength: Int
        get() = (viewerFlags and AUDIOBOOK_INTRO_MASK).toInt()

    val nextChapterToAir: Int
        get() = (viewerFlags and AUDIOBOOK_AIRING_CHAPTER_MASK).removeHexZeros(zeros = 2).toInt()

    val nextChapterAiringAt: Long
        get() = (viewerFlags and AUDIOBOOK_AIRING_TIME_MASK).removeHexZeros(zeros = 6)
    ...
    companion object {
        ...
        const val AUDIOBOOK_INTRO_MASK = 0x000000000000FFL
        const val AUDIOBOOK_AIRING_CHAPTER_MASK = 0x00000000FFFF00L
        const val AUDIOBOOK_AIRING_TIME_MASK = 0xFFFFFFFF000000L

        fun create() = Audiobook(
            id = -1L,
            url = "",
            title = "",
            source = -1L,
            ...
            status = 0L,
            thumbnailUrl = null,
            updateStrategy = AudiobookUpdateStrategy.ALWAYS_UPDATE,
            initialized = false,
            lastModifiedAt = 0L,
