...
object ChapterRecognition {
    ...
    fun parseChapterNumber(audiobookTitle: String, chapterName: String, chapterNumber: Double? = null): Double {
        ...
        // Remove audiobook title from chapter title.
        name = name.replace(audiobookTitle.lowercase(), "").trim()
