 ...
 */
class AudiobookDownloadJob(context: Context, workerParams: WorkerParameters) :
    ...
    companion object {
        private const val TAG = "AudiobookDownloader"

        fun start(context: Context) {
            val request = OneTimeWorkRequestBuilder<AudiobookDownloadJob>()
                .addTag(TAG)
                .build()
