...
@Composable
fun AudiobookTrackerSearch(
    query: TextFieldValue,
    onQueryChange: (TextFieldValue) -> Unit,
    onDispatchQuery: () -> Unit,
    queryResult: Result<List<AudiobookTrackSearch>>?,
    selected: AudiobookTrackSearch?,
    onSelectedChange: (AudiobookTrackSearch) -> Unit,
...
private fun TrackerSearchPreviews(
    @PreviewParameter(AudiobookTrackerSearchPreviewProvider::class)
