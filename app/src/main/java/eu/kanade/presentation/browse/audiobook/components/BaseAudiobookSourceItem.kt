...
@Composable
fun BaseAudiobookSourceItem(
    source: AudiobookSource,
    modifier: Modifier = Modifier,
    showLanguageInContent: Boolean = true,
    onClickItem: () -> Unit = {},
    onLongClickItem: () -> Unit = {},
    icon: @Composable RowScope.(AudiobookSource) -> Unit = defaultIcon,
    action: @Composable RowScope.(AudiobookSource) -> Unit = {},
    content: @Composable RowScope.(AudiobookSource, String?) -> Unit = defaultContent,
) {
...
private val defaultIcon: @Composable RowScope.(AudiobookSource) -> Unit = { source ->
    AudiobookSourceIcon(source = source)
}

private val defaultContent: @Composable RowScope.(AudiobookSource, String?) -> Unit = { source, sourceLangString ->
    Column(
        modifier = Modifier
