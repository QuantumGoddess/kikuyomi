 ...
 */
internal class AudiobookExtensionInstaller(private val context: Context) {
     ...
     */
    fun downloadAndInstall(url: String, extension: AudiobookExtension): Flow<InstallStep> {
    ...
    fun installApk(downloadId: Long, uri: Uri) {
        when (val installer = extensionInstaller.get()) {
            BasePreferences.ExtensionInstaller.LEGACY -> {
                val intent = Intent(context, AudiobookExtensionInstallActivity::class.java)
            ...
            BasePreferences.ExtensionInstaller.PRIVATE -> {
                val extensionManager = Injekt.get<AudiobookExtensionManager>()
                ...
                try {
                    ...
                    if (AudiobookExtensionLoader.installPrivateExtensionFile(context, tempFile)) {
                ...
                val intent =
                    AudiobookExtensionInstallService.getIntent(context, downloadId, uri, installer)
    ...
    fun cancelInstall(pkgName: String) {
        ...
        InstallerAudiobook.cancelInstallQueue(context, downloadId)
    }
    ...
    fun uninstallApk(pkgName: String) {
        if (context.isPackageInstalled(pkgName)) {
            ...
            AudiobookExtensionInstallReceiver.notifyRemoved(context, pkgName)
        }
    }
    ...
    companion object {
        ...
        const val EXTRA_DOWNLOAD_ID = "AudiobookExtensionInstaller.extra.DOWNLOAD_ID"
