...
class AudioplayerBackgroundService : Service(), MPVLib.EventObserver {
    ...
    private fun buildNotification(audiobookId: Long?, episodeId: Long?): Notification {
        val notificationIntent = Intent(this, AudioplayerActivity::class.java).apply {
            logcat { audiobookId.toString() }
    ...
    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        ...
        val notification = buildNotification(audiobookId, episodeId)
    ...
    override fun eventProperty(property: String, value: Boolean) {
        ...
        notificationManager.notify(NOTIFICATION_ID, buildNotification(audiobookId, episodeId))
    }
