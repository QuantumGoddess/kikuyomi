...
@Composable
fun GlobalAudiobookSearchToolbar(
    searchQuery: String?,
    progress: Int,
    total: Int,
    navigateUp: () -> Unit,
    ...
    sourceFilter: AudiobookSourceFilter,
    ...
    Column(modifier = Modifier.background(MaterialTheme.colorScheme.surface)) {
        ...
        Row(
            ...
            FilterChip(
                selected = sourceFilter == AudiobookSourceFilter.PinnedOnly,
                onClick = { onChangeSearchFilter(AudiobookSourceFilter.PinnedOnly) },
                leadingIcon = {
                    Icon(
            ...
            FilterChip(
                selected = sourceFilter == AudiobookSourceFilter.All,
                onClick = { onChangeSearchFilter(AudiobookSourceFilter.All) },
                leadingIcon = {
                    Icon(
