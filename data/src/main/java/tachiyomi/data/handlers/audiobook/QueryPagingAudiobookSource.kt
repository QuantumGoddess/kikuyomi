...
class QueryPagingAudiobookSource<RowType : Any>(
    val handler: AudiobookDatabaseHandler,
    val countQuery: AudiobookDatabase.() -> Query<Long>,
    val queryProvider: AudiobookDatabase.(Long, Long) -> Query<RowType>,
