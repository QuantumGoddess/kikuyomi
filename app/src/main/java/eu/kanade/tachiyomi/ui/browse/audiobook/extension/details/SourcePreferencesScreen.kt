...
import eu.kanade.tachiyomi.audiobooksource.sourcePreferences
...
class SourcePreferencesScreen(val sourceId: Long) : Screen() {
    ...
    override fun Content() {
        ...
        Scaffold(
            topBar = {
                AppBar(
                    title = Injekt.get<AudiobookSourceManager>().getOrStub(sourceId).toString(),
...
class SourcePreferencesFragment : PreferenceFragmentCompat() {
    ...
    private fun populateScreen(): PreferenceScreen {
        ...
        val source = Injekt.get<AudiobookSourceManager>().get(sourceId)!! as ConfigurableAudiobookSource
