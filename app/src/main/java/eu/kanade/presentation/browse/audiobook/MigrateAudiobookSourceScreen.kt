...
import eu.kanade.presentation.browse.audiobook.components.AudiobookSourceIcon
import eu.kanade.presentation.browse.audiobook.components.BaseAudiobookSourceItem
import eu.kanade.tachiyomi.ui.browse.audiobook.migration.sources.MigrateAudiobookSourceScreenModel
...
@Composable
fun MigrateAudiobookSourceScreen(
    state: MigrateAudiobookSourceScreenModel.State,
    contentPadding: PaddingValues,
    onClickItem: (AudiobookSource) -> Unit,
...
@Composable
private fun MigrateAudiobookSourceList(
    list: List<Pair<AudiobookSource, Long>>,
    contentPadding: PaddingValues,
    onClickItem: (AudiobookSource) -> Unit,
...
@Composable
private fun MigrateAudiobookSourceItem(
    ...
    BaseAudiobookSourceItem(
        ...
        icon = { AudiobookSourceIcon(source = source) },
        action = {
            BadgeGroup {
                Badge(text = "$count")
            }
